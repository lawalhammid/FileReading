...
{
    public class CBSRiaRepository : Repository<CBSRiaTran>, ICBSRiaRepository
    {
        public CBSRiaRepository(IDbFactory dbFactory)
            : base(dbFactory) { }
    }
    public interface ICBSRiaRepository : IRepository<CBSRiaTran>
    {
