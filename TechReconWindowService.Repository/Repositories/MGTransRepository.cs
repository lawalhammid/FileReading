...
{
    public class MGTransRepository : Repository<MGTran>, IMGTransRepository
    {
        public MGTransRepository(IDbFactory dbFactory)
            : base(dbFactory) { }
    }
    public interface IMGTransRepository : IRepository<MGTran>
    {
