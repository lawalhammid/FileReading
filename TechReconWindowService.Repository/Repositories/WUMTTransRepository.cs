...
{
    public class WUMTTransRepository : Repository<WUMTTran>, IWUMTTransRepository
    {
        public WUMTTransRepository(IDbFactory dbFactory)
            : base(dbFactory) { }
    }
    public interface IWUMTTransRepository : IRepository<WUMTTran>
    {
