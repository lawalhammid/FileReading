...
{
    public class MTNTRansRepository : Repository<MTNTRan>, IMTNTRansRepository
    {
        public MTNTRansRepository(IDbFactory dbFactory)
            : base(dbFactory) { }
    }
    public interface IMTNTRansRepository : IRepository<MTNTRan>
    {
