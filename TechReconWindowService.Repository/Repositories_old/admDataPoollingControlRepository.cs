...
{
    public class admDataPoollingControlRepository : Repository<admDataPoollingControl>, IadmDataPoollingControlRepository
    {
        public admDataPoollingControlRepository(IDbFactory dbFactory)
            : base(dbFactory) { }
    }
    public interface IadmDataPoollingControlRepository : IRepository<admDataPoollingControl>
    {
